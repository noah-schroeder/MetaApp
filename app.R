...
ui <- fluidPage(
  # Application title
  titlePanel("Conventional Random Effects Meta-Analysis Calculator"),
  ...
  navlistPanel(
    ...
    tabPanel("Introduction",
             ...
             p("This app was written by Noah L. Schroeder, Ph.D. using Shiny, metafor, and tidyverse packages for R. The goal was to create an efficient, and free, GUI for conducting meta-analyses while I learned how to use Shiny. If you use this app for your analyses, please cite as:"),
             p("Schroeder, N. L. (2024). Conventional Random Effects Meta-Analysis Calculator. Available at", HTML("<a href='https://noahschroeder.shinyapps.io/MetaApp'>https://noahschroeder.shinyapps.io/MetaApp</a>")),
  ),
  ...
  tabPanel("Validation and Underlying Code",
           ...
           p("Here is a link to a document which shows some of the comparisons between the app and JAMOVI", HTML("<a href='https://drive.google.com/file/d/1OufnX91Db79yPaz4fEW46xSZ0jT-CMjx/view?usp=drive_link'>Validation Analyses,</a>")),
